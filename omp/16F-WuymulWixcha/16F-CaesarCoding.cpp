...
//Devuelve el string s "desplazado" n posiciones Ascii
//Solamente desplaza letras
...
int main () {
	...
	while(true) {
		...
		if (desfase == 0)
			break;
		string s;
		getline(cin, s);	//Vaciar el buffer de cin para evitar leer en blanco
		getline(cin, s);
